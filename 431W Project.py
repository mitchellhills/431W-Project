...
while(True):
    ...
    if(query_selection == "1"): #Insert Data
        ...
        column1 = input("Enter the team ID: ") #55
        column2 = input("Enter the franchise ID: ") #39
        column3 = input("Enter the home city: ") #Seattle
        column4 = input("Enter the team name: ") #Krakens
        column5 = input("Enter the team abbrevation: ") # SEA
    ...
    if(query_selection == "2"): #Delete Data
        ...
        condition = input("Enter the team ID: ") #55
    ...
    if(query_selection == "3"): #Update Data
        ...
        firstName = input("Enter the player's first name: ") #Sidney
        lastName = input("Enter the player's last name: ") #Crosby
        newWeight = input("Enter the player's new weight: ") #205
    ...
    if(query_selection == "4"): #Search Data
        ...
        nationality = input("Enter the nationality of the players to search for: ") #FRA
    ...
    if(query_selection == "5"): #Aggregate
        ...
        stat = input("Enter the team stat for aggregation: ") #goals
        aggregation = input("Enter the aggregation to perform on the team stat: ") #summation
    ...
    if(query_selection == "6"): #Sorting
        ...
        stat = input("Enter the stat to sort by: ") #saves
        sort = input("Enter whether to sort in descending or ascending order: ") #descending
        if(sort == "descending"):
            sort = "DESC"
        if(sort == "ascending"):
            sort = "ASC"
    ...
    if(query_selection == "7"): #Join
        ...
        join = input("Enter whether you want additional location or score information on played games: ") #location
        if(join == "location"):
            join = "location"
        if(join == "score"):
            join = "game_score"   
    ...
    if(query_selection == "8"): #Grouping
        ...
        characteristic = input("Enter the characteristic to count: ") #nationality
    ...
    if(query_selection == "9"): #Subquery
        ...
        goals = input("Enter the the minimun number of goals scored in the game to search for: ") #13
    ...
    if(query_selection == "10"): #Transaction
        ...
        firstName = input("Enter the player's first name: ") #Brent
        lastName = input("Enter the player's last name: ") #Burns
        newPosition = input("Enter the player's new primary position: ") #RW
    ...
    if(query_selection == "11"): #Error Handling
        print("Follow the prompts to delete a NHL team")
        condition = input("Enter the team ID: ") #one
        query = "DELETE FROM public.team_info WHERE \"team_id\" = " + condition
        print(query)
        try:
            cur.execute(query)
